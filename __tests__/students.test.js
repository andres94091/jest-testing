...
// describe('GET /', () => {
//   it('Should respond with an array of students', async () => {
...
describe('GET students/', () => {
  it('responds with and array of students', async () => {
...
describe('PATCH /students/1', () => {
  it('responds with an updated student', async () => {
    const newStudent = await request(app)
      .post('/students')
      .send({
        name: 'Another one'
...
describe('DELETE /students/1', () => {
  it('responds with a message of Deleted', async () => {
    const newStudent = await request(app)
      .post('/students')
      .send({
        name: 'Another one'
